...
const LoadSummary = ({ items, container }) => {
  ...
  const weightPercentage = Math.min(100, (totalWeight / containerSpec.maxWeight) * 100);
    ...
    <div className="load-summary">
      <div ref={summaryRef}>
        ...
        <div className="summary-item">
          <span>Total CBM:</span>
          <span>{totalCBM} m³ ({cbmPercentage.toFixed(1)}% of container)</span>
        </div>
        <div className="summary-item">
          <span>Total Weight:</span>
          <span>{totalWeight} kg ({weightPercentage.toFixed(1)}% of limit)</span>
        </div>
        <div className="summary-item">
        ...
        {totalCBM > containerSpec.volume && (
          <div className="warning">Warning: CBM exceeds container capacity!</div>
        )}
        {totalWeight > containerSpec.maxWeight && (
          <div className="warning">Warning: Weight exceeds container limit!</div>
        )}
      </div>
